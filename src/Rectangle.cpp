...
Rectangle* Rectangle::Modify(point origin, int width, int height, int angle, std::string stroke_color, int stroke_width, std::string fill_color, double fill_opacity)
{
	m_origin = origin;
	m_width = width;
	m_height = height;
