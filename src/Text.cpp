...
Text* Text::Modify(point origin, std::string text, std::string font_family, int font_size , int angle, std::string stroke_color, int stroke_width, std::string fill_color, double fill_opacity)
{
	m_origin = origin;
	m_text = text;
...
Text* Text::ChangeText(std::string text, std::string font_family, int font_size)
{
	m_text = text;
	m_font_family = font_family;
	m_font_size = font_size;
